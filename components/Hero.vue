    ...
    <header class="absolute inset-x-0 top-0 z-50">
      ...
      >
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <ULink
            to="/auth/login"
            class="text-sm font-semibold leading-6 dark:text-white"
            >Log in <span aria-hidden="true">&rarr;</span></ULink
          >
        </div>
      </nav>
      <Dialog
            ...
            <div class="-my-6 divide-y divide-gray-500/25">
              <div class="space-y-2 py-6">
                <a
                  ...
                  :key="item.name"
                  :href="item.href"
                  class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 dark:text-white hover:bg-gray-800"
                  >{{ item.name }}</a
                >
              </div>
              <div class="py-6">
                <ULink
                  to="/auth/login"
                  class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-800"
                  >Log in
                </ULink>
              </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-6 text-lg leading-8 text-zinc-500 dark:text-zinc-300">
              Stay organised with Keo! Each task provides a space to keep notes
              as well as it's own assistant for you to chat with. Assistants can
              learn and understand your task in order to provide the best help!
            </p>
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <ULink
                to="/auth/signup"
                class="rounded-md bg-black dark:bg-white dark:text-black px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-zinc-800 dark:hover:bg-zinc-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
                >Get started
              </ULink>
              <a
                href="#features"
